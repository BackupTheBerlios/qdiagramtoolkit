...
******************************************************************************/
#ifndef QDIAGRAMSHADOWSTYLE_H
#define QDIAGRAMSHADOWSTYLE_H
...
class QDIAGRAMLIBSHARED_EXPORT QDiagramShadowStyle : public QDiagramStyle
{
public:
    /**
      * Constructs an empty (invalid) QDiagramShadowStyle.
      */
	QDiagramShadowStyle();
	/**
...
Q_DECLARE_METATYPE(QDiagramShadowStyle)

#endif // QDIAGRAMSHADOWSTYLE_H
